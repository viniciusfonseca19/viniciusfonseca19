...
## 🎯 Sobre mim
Sou **Vinícius Fonseca**, desenvolvedor com foco em **Java, Spring e Python**, interessado em desenvolvimento de **APIs REST** e aplicações web. Tenho experiência em **front-end** com React, HTML, CSS e JavaScript. Busco evoluir constantemente e aplicar boas práticas no dia a dia.
